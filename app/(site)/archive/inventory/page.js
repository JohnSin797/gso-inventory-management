...
export default function Inventory () {
    ...
    const destroy = async id => {
        try {
            await axios.post('/api/inventory/destroy', {id:id})
            .then(res=>{
                getData()
    ...
    const restore = async id => {
        try {
            await axios.post('/api/inventory/restore', {id: id})
            .then(res=>{
                getData()
                Swal.fire(res.data.message)
            })
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td className="flex gap-2 p-2 border border-slate-900">
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-2 rounded-lg bg-red-600 hover:bg-red-600/80 text-white"
                                                        >
                                                            delete
                                                        </button>
                                                    </td>
